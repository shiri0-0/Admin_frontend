...
export default function Hero() {
  ...
  <main className="section-slides">
        ...
        <div className="container">
          <div className="banner-inner-content">
            ...
            <div className="banner-inner-text">
              ...
              <p className="subheading banner-desc">
                The ideal framework to learn how to manage all aspects of
                startup.
              </p>
              <a href="#" className="btn-prime banner-btn">
                <div className="btn-wrap" />
                <div className="btn-text">Start for free</div>
              </a>
            </div>
            {/*  Banner Images */}
          ...
          <div className="banner-stats">
            <div className="banner-stat-item">
              <div className="item-num">
                ...
                <div className="item-num-text">200+</div>
              </div>
              <p className="item-p">
                Ideal courses to sell physical and digital products from your
            ...
            <div className="syllabus-steps">
              ...
              <div className="syllabus-step-list">
                ...
                <div className="syllabus-step">
                  ...
                  <p className="item-p">
                    Structure and visualize new knowledge. You send the
                    practical work to the reviewing specialists and receive
                    individual feedback.
                  </p>
                  <div className="step-arrow-wrap">
                    <img
                      src="./images/steps_arrow-plane.svg"
                      loading="lazy"
                      alt=""
                      className="step-arrow-img"
                    />
    ...
    {/* Services */}
    <div className="section-slide services">
      <div className="container">
        ...
        <div className="services-inner">
          <div className="service-card">
            <div className="service-card-head">
              <h4 className="service-card-tag">design</h4>
              <h3 className="service-title item-title">
          ...
          <div className="service-card">
            <div className="service-card-head">
              <h4 className="service-card-tag">programming</h4>
              <h3 className="service-title item-title">
          ...
          <div className="service-card">
            <div className="service-card-head">
              <h4 className="service-card-tag">seo</h4>
              <h3 className="service-title item-title">
    ...
    {/* Questions */}
    <div className="section-slide questions">
      <div className="container">
        <div className="questions-inner">
          ...
          <div className="questions-img">
            ...
            <img
              ...
              alt="Plane"
            />
            <div className="questions-circle-border" />
            <div className="questions-circle-color" />
            <div className="questions-circle-dot" />
          </div>
        </div>
      </div>
    </div>
        ...
        <div className="footer-top">
          ...
          <div className="footer-top-right">
            ...
            <ul className="footer-menu">
              ...
              <li>
                <a href="tel:+380962722100" className="animate-link">
                  +38 096 272 2100
                </a>
              </li>
              <li>
                <a href="mailto:mail@halo-lab.com" className="animate-link">
                  mail@halo-lab.com
                </a>
              </li>
        ...
        <div className="footer-bottom">
          <a href="#" className="copyright">
            ...
            <div className="copyright-text">
              2022 Halo Lab. All rights reserved
            </div>
          </a>
